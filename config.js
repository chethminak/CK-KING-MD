...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("94722770762")
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'CK-KING-MD' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Chethmina Kavishan' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_AUTHER.split("ᴄᴋ ʙᴏᴛꜱ ᴢᴏɴᴇ;2024")[0] === undefined ? 'Naveed-Dogar' : process.env.PACK_AUTHER.split(";")[0],
